#!/usr/bin/env python3
"""
CMA-ES profile parameter optimizer CLI.

Uses Covariance Matrix Adaptation Evolution Strategy to search for
HeuristicProfile parameters that achieve the targets defined below.

Usage:
    python run_cmaes.py                           # Default settings
    python run_cmaes.py --generations 100 --games 200
    python run_cmaes.py --sigma 0.2 --games 300   # Smaller step size
"""
...
from optimizer.cmaes import CMAESOptimizer
from optimizer.results import save_results, format_profile_as_code
...
WIN_RATE_TARGET = 0.5    # Minimum win rate vs v1 (0.8 = 80%)
# =============================================================================


def main():
    parser = argparse.ArgumentParser(
        description='Optimize AI profile parameters using CMA-ES',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
    # Quick test run
    python run_cmaes.py --generations 10 --games 50

    # Standard optimization
    python run_cmaes.py --generations 100 --games 200

    # Thorough search with smaller steps
    python run_cmaes.py --generations 200 --games 300 --sigma 0.2
        """
    )
    ...
    parser.add_argument('--output', type=str, default='cmaes_results',
                        help='Output directory (default: cmaes_results)')
    ...
    print("=" * 60)
    print("CMA-ES PROFILE OPTIMIZER")
    print("=" * 60)
